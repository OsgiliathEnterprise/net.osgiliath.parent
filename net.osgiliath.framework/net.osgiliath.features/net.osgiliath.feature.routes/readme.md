# Karaf Features: Routes


## What is it?

Some more routing stuff (in addition of the messaging feature) for Osgiliath framework
...
You can now have some more routing stuffs on your project  

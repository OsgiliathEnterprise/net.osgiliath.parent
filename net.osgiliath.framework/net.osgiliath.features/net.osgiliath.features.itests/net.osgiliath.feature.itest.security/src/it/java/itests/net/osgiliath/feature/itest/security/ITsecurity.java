package itests.net.osgiliath.feature.itest.security;
...
import net.osgiliath.feature.itest.security.MUser;
import net.osgiliath.feature.itest.security.SecurityService;
...
public class ITsecurity extends AbstractPaxExamKarafConfiguration {
  ...
  public TestProbeBuilder extendProbe(TestProbeBuilder builder) {
    ...
    builder.setHeader(Constants.EXPORT_PACKAGE, "itests.net.osgiliath.feature.itest.security");

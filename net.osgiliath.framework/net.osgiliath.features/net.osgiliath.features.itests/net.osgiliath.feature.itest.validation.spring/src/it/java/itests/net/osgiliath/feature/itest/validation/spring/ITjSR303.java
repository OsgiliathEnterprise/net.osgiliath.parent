package itests.net.osgiliath.feature.itest.validation.spring;
...
import net.osgiliath.feature.itest.validation.spring.HelloObject;
import net.osgiliath.feature.itest.validation.spring.IValidatorFactorySample;
...
public class ITjSR303 extends AbstractPaxExamKarafConfiguration {
  ...
  public TestProbeBuilder extendProbe(TestProbeBuilder builder) {
    ...
    builder.setHeader(Constants.EXPORT_PACKAGE,
        "itests.net.osgiliath.feature.itest.validation.spring");
  ...
  protected Option featureToTest() {
    return features(
        ...
        "osgiliath-itests-validation-spring");
  }

...
import net.osgiliath.helper.swagger.cdi.CXFBeanJaxrsScanner;
...
public class SwaggerBeanConfig {
	...
	public BeanConfig getConfig() {
		final BeanConfig beanConfig = new CXFBeanJaxrsScanner(this.getClass().getClassLoader());
		...
		String endPointURI = "";
		try {
		  endPointURI = tracker.getProperty("jaxrs.server.protocol") + "://" + tracker.getProperty("jaxrs.server.uri") + ":" + tracker.getProperty("jaxrs.server.port")  + "/cxf" + CXFApplication.class.getAnnotation(ApplicationPath.class).value();

package mocks.net.osgiliath.sample.enterprise.routes;
...
public class HelloCDIRouteEndpointsMock extends RouteBuilder {
  ...
  public void configure() throws Exception {
    ...
    from("properties:{{helloApp.restEndpoint}}/hello").choice()
